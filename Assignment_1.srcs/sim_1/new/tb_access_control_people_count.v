...
module tb_access_control_people_count();
    ...
    initial begin
        ...
        //--                     TEST01                    --
        //---------------------------------------------------
        #20 $display("[TEST 01] Increase number of people inside the vault");
        ...
        //--                     TEST02                    --
        //---------------------------------------------------
        #20 $display("[TEST 02] Decrease number of people inside the vault");
        ...
        //--                     TEST03                    --
        //---------------------------------------------------
        #20 $display("[TEST 03] Increase and decrease number of people inside the vault");
        ...
        #30 inc_people = 1'b1; // -> 1
        #30 inc_people = 1'b0; // -> 2
        #30 inc_people = 1'b1; // -> 3
        #30 dec_people = 1'b1; // -> 2
    
        #30 if(num_people != 4'd2) begin
            $display("[TEST 03] FAILED: The number of people should be 2, actual %d", num_people);
            $finish();
        end
        
        #20 security_reset = 1'b1;
        #20 security_reset = 1'b0;
